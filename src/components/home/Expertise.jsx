      ...
      <div className="mx-auto max-w-6xl px-4 py-16">
        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {ITEMS.map((it) => (
            <div
              key={it.key}
              className="bg-card group rounded-2xl border border-border/60 p-6 shadow-sm transition hover:shadow-md"
            >
              ...
              <h3 className="font-semibold">{t(`home.expertise.${it.key}.title`)}</h3>
